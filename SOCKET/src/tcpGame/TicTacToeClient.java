...
public class TicTacToeClient {
     ...
     * will be s
     * @throws java.lang.Exceptionent a "QUIT" message also.
     */
    public void play() throws Exception {
        String response;
        
        String crossIcon = "C:\\Users\\Marius\\Documents\\NetBeansProjects\\TCP\\src\\tcpGame\\x.gif";
        String zeroIcon = "C:\\Users\\Marius\\Documents\\NetBeansProjects\\TCP\\src\\tcpGame\\o.gif";
        try {
            ...
            if (response.startsWith("WELCOME")) {
                ...
                icon = new ImageIcon(mark == 'X' ? crossIcon : zeroIcon);
                opponentIcon  = new ImageIcon(mark == 'X' ? zeroIcon : crossIcon);
    ...
    public static void main(String[] args) throws Exception {
        while (true) {
            String serverAddress = (args.length == 0) ? "192.168.2.128" : args[1];
            TicTacToeClient client = new TicTacToeClient(serverAddress);
            client.frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
            client.frame.setSize(660, 660);
